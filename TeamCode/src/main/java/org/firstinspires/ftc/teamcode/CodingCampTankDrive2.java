...
public class CodingCampTankDrive2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            rightFrontMotor.setPower(this.gamepad1.left_stick_y+this.gamepad1.right_stick_x+this.gamepad1.left_stick_x);
            rightRearMotor.setPower(this.gamepad1.left_stick_y+this.gamepad1.right_stick_x-this.gamepad1.left_stick_x);

            leftFrontMotor.setPower(this.gamepad1.left_stick_y-this.gamepad1.right_stick_x-this.gamepad1.left_stick_x);
            leftRearMotor.setPower(this.gamepad1.left_stick_y-this.gamepad1.right_stick_x+this.gamepad1.left_stick_x);
        }
    }
}